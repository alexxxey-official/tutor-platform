    ...
    <div className="min-h-screen bg-[#faf8f3] text-[#1a1a2e] pb-20 font-sans">
      ...
      <div className="max-w-[860px] mx-auto px-6">
        ...
        <div className="bg-white border border-[#e5e0d5] rounded-2xl p-8 md:p-12 mb-4 mt-8 shadow-sm">
          ...
          <SentencePair 
            spanish="Me gusta mucho leer и слушать музыку. По выходным я гуляю по парку с друзьями." 
        ...
        <div className="mt-12">
            ...
            <ExerciseItem id="hw1" q="Сколько ему лет? (словом по-испански или числом)" ans="25" mode="hw" />
